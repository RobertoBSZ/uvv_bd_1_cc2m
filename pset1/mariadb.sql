...
/*Criando o banco de dados/esquema UVV configurações dadas no pset:
 SET utf8mb4 e COLLATE utfmb4_unicode_ci*/
CREATE DATABASE uvv CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

/*Colocando as permissões CREATE e INSERT em todas as tabelas
 do banco de dados uvv para o usuário roberto*/
GRANT CREATE, INSERT, SELECT, INDEX, REFERENCES ON uvv.* to 'roberto'@'localhost';

/* Conectando o usuário roberto para ele entrar no banco de dados*/
SYSTEM mysql -u 'roberto'@'localhost' -p;
...
/*Criando a tabela departamento e adcionando CHECK no numero_departamento, 
onde o numero_departamento não pode ser negativo*/
